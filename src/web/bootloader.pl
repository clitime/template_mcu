...
#print(OUTPUT "const struct fsdata_file file".$fvars[$i]." = {file$fvars[$i - 1], data$fvars[$i], ");
#print(OUTPUT "data$fvars[$i] + ". (length($fvars[$i]) + 1) .", ");
#print(OUTPUT "sizeof(data$fvars[$i]) - ". (length($fvars[$i]) + 1) ."};\n\n");
...
print(OUTPUT2 "\n");
print(OUTPUT2 "#include \"lwip/opt.h\"\n");
